 ...
 */
public class Q1  extends Fragment implements View.OnClickListener, TextToSpeech.OnInitListener{
    ...
    @Override
    public void onClick(View view) {
        if(view.getId() == R.id.imageButton4 || view.getId() == R.id.imageButton5 || view.getId() == R.id.imageButton3 || view.getId() == R.id.imageButton || view.getId() == R.id.imageButton2 || view.getId() == R.id.imageButton1) {
            switch (view.getId()) {
