...
public class Q2 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rooteView = inflater.inflate(R.layout.examq2, container, false);
    ...
    public void onClick(View view) {
        switch(view.getId()){
            ...
            case R.id.contain1 : contain1.setBackgroundColor(getResources().getColor(R.color.colorBlue));textview2.setTextColor(getResources().getColor(R.color.colorWhite));correctanswer = true;
